    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
            ...
            <table className="w-full">
              ...
              >
                {events.map((event, index) => (
                  ...
                  >
                    <td className="py-4 px-6 text-gray-800 font-medium">{event.date}</td>
                    <td className="py-4 px-6 text-gray-600">{event.time}</td>
                    <td className="py-4 px-6 text-gray-800 font-medium">{event.title}</td>
                    <td className="py-4 px-6 text-gray-600">{event.description}</td>
        ...
        <motion.div 
          ...
          viewport={{ amount: 0.3 }}
        >
          <p className="text-gray-600 mb-4">Want to schedule a consultation?</p>
          <motion.button 
