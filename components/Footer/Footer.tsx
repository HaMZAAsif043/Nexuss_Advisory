        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services/financial-planning" className="text-gray-300 hover:text-white transition-colors">Financial Planning</Link></li>
              <li><Link href="/services/investment-advisory" className="text-gray-300 hover:text-white transition-colors">Investment Advisory</Link></li>
              <li><Link href="/services/tax-planning" className="text-gray-300 hover:text-white transition-colors">Tax Planning</Link></li>
              <li><Link href="/services/business-advisory" className="text-gray-300 hover:text-white transition-colors">Business Advisory</Link></li>
              <li><Link href="/services/audit-services" className="text-gray-300 hover:text-white transition-colors">Audit Services</Link></li>
              <li><Link href="/services/career-program" className="text-gray-300 hover:text-white transition-colors">Career Program</Link></li>
            </ul>
          </div>
