        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-[#545454]/80 rounded-full flex items-center justify-center hover:bg-[#4DC6D7] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/services/financial-planning" className="text-white/80 hover:text-white transition-colors">Financial Planning</Link></li>
              <li><Link href="/services/investment-advisory" className="text-white/80 hover:text-white transition-colors">Investment Advisory</Link></li>
              <li><Link href="/services/tax-planning" className="text-white/80 hover:text-white transition-colors">Tax Planning</Link></li>
              <li><Link href="/services/business-advisory" className="text-white/80 hover:text-white transition-colors">Business Advisory</Link></li>
              <li><Link href="/services/audit-services" className="text-white/80 hover:text-white transition-colors">Audit Services</Link></li>
              <li><Link href="/services/career-program" className="text-white/80 hover:text-white transition-colors">Career Program</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/news" className="text-white/80 hover:text-white transition-colors">News & Insights</Link></li>
